  ...
  <div class="AllArea">
    ...
    <el-container style="height: 590px">
          ...
          >
            ...
            <el-submenu index="1">
              ...
              <el-menu-item-group>
                ...
                <el-menu-item index="1-1">基本信息录入</el-menu-item>
              ...
              <el-menu-item-group>
                ...
                <el-menu-item index="1-1">专业录入</el-menu-item>
                <el-menu-item index="1-2">基本信息处理</el-menu-item>
              </el-menu-item-group>
      ...
      <el-container class="workingArea">
        <el-header style="text-align: right; font-size: 18px;height: 53px">
          ...
          >用户:{{this.$route.params.name}},{{this.$route.params.manaPemission}}</span>
        </el-header>
...
export default {
  data() {
    ...
    return {
      ...
      msg: [
        {
          name: this.$route.msg.name,
          manaPemission: this.$route.msg.manaPemission
        }
      ]
    };
    rules: {
